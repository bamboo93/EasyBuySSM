							...
							<li>
								<div class="fj">
									<span class="n_img"><span></span> <img src="" /></span> <span
										class="fl">${category1.name }</span>
								</div>
								<div class="zj">
									<div class="zj_l">
										<c:forEach items="${category1.category }" var="category2">
											<div class="zj_l_c">
											<h2>
												<a href="productList?level=2&id=${category2.id }&page=1">${category2.name }</a>
											</h2>
											<c:forEach items="${category2.category }" var="category3">
												<a href="productList?level=3&id=${category3.id }&page=1">${category3.name }</a>|
											</c:forEach> 
										</div>
										</c:forEach>
